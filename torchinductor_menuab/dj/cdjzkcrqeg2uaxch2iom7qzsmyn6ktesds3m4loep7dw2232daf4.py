...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/lj/cljvfqsfxfhy4mmd7uvfvefgwcpxqqmmtfqcsol3aysv3zsvykyc.py
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: 'i32', 5: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=108), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5), equal_to_1=())]},
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/mu/cmunh55almdx766eyqminykk5wif5l4r5uyrjn4yn5yiowq72szq.py
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/lb/clbcgotswc3kxfxoagvrpesydahidqr3mbborlpnkwwyo7yhdtxt.py
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/kh/ckhsmzashjbwofguq5pcxu7pyvqy74zrt5ovx2vnkh6z5tpzizy4.py
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/je/cjett3i4wcgt5hsbvh5kvcm5wryzomhentqnovzhueo7ib2nzuud.py
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/di/cdihgb3xv3v46cu74hlrwqayz3rntpzu7fkddifs6hnow3ey2i4g.py
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/q3/cq3alqgu7sfbyr64g2dxey3xfjzuuynanwlp2qazbsnnma2xkgx4.py
...
@triton_heuristics.reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {0: '*fp32', 1: '*bf16', 2: '*bf16', 3: '*bf16', 4: '*bf16', 5: 'i32', 6: 'i32'}, 'device': DeviceProperties(type='cuda', index=0, cc=80, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, multi_processor_count=108), 'constants': {}, 'configs': [AttrsDescriptor(divisible_by_16=(0, 1, 2, 3, 4, 5, 6), equal_to_1=())]},
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/4c/c4cpx5hhhdhlmgadvvuwj7623vuu44iup6xghmqypb5vp3qvptlv.py
...
# kernel path: /auto/home/menuab/code/YNNtitan/torchinductor_menuab/qq/cqqgwzy5hyv333wrij3z4bksyqksrgovwyasn4yius2yxh73xkqj.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_0.run(buf1, primals_2, primals_1, buf2, 8192, 2048, grid=grid(8192), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [xq_], Original ATen: [aten.view_as_complex]
        triton_poi_fused_view_as_complex_1.run(buf3, buf6, 16777216, grid=grid(16777216), stream=stream0)
        # Topologically Sorted Source Nodes: [xq_], Original ATen: [aten.view_as_complex]
        buf7 = torch.ops.aten.view_as_complex.default(buf6)
        buf8 = buf7
        buf9 = empty_strided_cuda((4, 2048, 8, 32, 2), (1048576, 512, 64, 2, 1), torch.float32)
        # Topologically Sorted Source Nodes: [xk_], Original ATen: [aten.view_as_complex]
        triton_poi_fused_view_as_complex_2.run(buf4, buf9, 4194304, grid=grid(4194304), stream=stream0)
        del buf4
        # Topologically Sorted Source Nodes: [xk_], Original ATen: [aten.view_as_complex]
        ...
        # Topologically Sorted Source Nodes: [xq_2], Original ATen: [aten._to_copy]
        triton_poi_fused__to_copy_3.run(buf19, buf24, 16777216, grid=grid(16777216), stream=stream0)
        del buf17
        del buf18
        del buf19
        buf25 = empty_strided_cuda((4, 2048, 8, 4, 64), (4194304, 2048, 256, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [keys], Original ATen: [aten.clone]
        triton_poi_fused_clone_4.run(buf23, buf25, 16777216, grid=grid(16777216), stream=stream0)
        del buf21
        del buf22
        del buf23
        buf26 = empty_strided_cuda((4, 2048, 8, 4, 64), (4194304, 2048, 256, 64, 1), torch.bfloat16)
        # Topologically Sorted Source Nodes: [values], Original ATen: [aten.clone]
        triton_poi_fused_clone_5.run(buf5, buf26, 16777216, grid=grid(16777216), stream=stream0)
        del buf5
        ...
        # Topologically Sorted Source Nodes: [h, float_4, pow_2, mean_1, add_2, rsqrt_1, mul_4, output_4, mul_5], Original ATen: [aten.add, aten._to_copy, aten.pow, aten.mean, aten.rsqrt, aten.mul]
        triton_red_fused__to_copy_add_mean_mul_pow_rsqrt_6.run(buf35, primals_2, buf33, primals_8, buf36, 8192, 2048, grid=grid(8192), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [silu, mul_6], Original ATen: [aten.silu, aten.mul]
        triton_poi_fused_mul_silu_7.run(buf37, buf38, buf39, 67108864, grid=grid(67108864), stream=stream0)
        ...
        # Topologically Sorted Source Nodes: [h, out], Original ATen: [aten.add]
        triton_poi_fused_add_8.run(buf41, primals_2, buf33, 16777216, grid=grid(16777216), stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_3 = rand_strided((2048, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_4 = rand_strided((512, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_5 = rand_strided((512, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_6 = rand_strided((4096, 32), (32, 1), device='cuda:0', dtype=torch.complex64)
    primals_7 = rand_strided((2048, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_8 = rand_strided((2048, ), (1, ), device='cuda:0', dtype=torch.bfloat16)
    primals_9 = rand_strided((8192, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_10 = rand_strided((8192, 2048), (2048, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_11 = rand_strided((2048, 8192), (8192, 1), device='cuda:0', dtype=torch.bfloat16)
