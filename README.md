...
python torchtitan/tokenizers/download_tokenizer.py --repo_id meta-llama/Meta-Llama-3-8B --tokenizer_path "original" --hf_token=...

# llama2 tokenizer.model
python torchtitan/tokenizers/download_tokenizer.py --repo_id meta-llama/Llama-2-13b-hf --hf_token=...
```
